...
from tests import TestCase, get_code
...
class ConcreteInstrTests(TestCase):
    ...
    def test_disassemble(self):
        ...
        self.assertEqual(instr, ConcreteInstr("EXTENDED_ARG", 0x1234, lineno=3))
...
class BytecodeToConcreteTests(TestCase):
    ...
    def test_extended_jump(self):
        ...
        expected = b"%c\x01\x00q\x06\x00" % EXTENDED_ARG + NOP * nb_nop + b"d\x00\x00S"
